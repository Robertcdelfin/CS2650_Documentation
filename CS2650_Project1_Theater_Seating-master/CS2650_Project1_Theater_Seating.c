...
#include <stdlib.h>///\headerfile stdlib.h "stdlib.h"
#include <stdio.h>///\headerfile stdio.h "stdio.h"

/// \file
///\brief the main method that starts the theater seating chart program.
...
int main (int argc, char** argv)
{
  ...
  int quit = 1; /// \var int quit The value to exit out of purchase loop
